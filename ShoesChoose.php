...
<body>
    <!--Shoes Men-->
    <ul class=" grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-4 sm:grid-cols-4 lg:grid-cols-6 w-full" id="Shoes-Summer-choose">
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesMen/ShoesMen1.jpg" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesMen/ShoesMen2.jpg" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesMen/ShoesMen3.jpg" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesMen/ShoesMen4.jpg" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesMen/ShoesMen5.jpg" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesMen/ShoesMen6.jpg" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesMen/ShoesMen7.jpg" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesMen/ShoesMen8.jpg" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesMen/ShoesMen9.jpg" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
        ...
        <!--Shoes Women-->
        <ul class="hidden grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-4 sm:grid-cols-4 lg:grid-cols-6 w-full" id="Shoes-women-choose">
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesWomen/ShoesWomen1.jpg" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                    <small class="text-sm text-gray-600 block text-lime-900">T-shirt classique</small>
                    <h3 class="text-base font-semibold text-lime-900">Summer Style</h3>
                    <div>
                        <i class="fa-solid fa-star text-yellow-300"></i>
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesWomen/ShoesWomen2.jpg" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                    <small class="text-sm text-gray-600 block text-lime-900">Chemise blanche</small>
                    <h3 class="text-base font-semibold text-lime-900">Urban Elegance</h3>
                    <i class="fa-solid fa-star text-yellow-300"></i>
                    <i class="fa-solid fa-star text-yellow-300"></i>
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesWomen/ShoesWomen3.webp" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                    <small class="text-sm text-gray-600 block text-lime-900">Polo bleu marine</small>
                    <h3 class="text-base font-semibold text-lime-900">Classic Polo</h3>
                    <i class="fa-solid fa-star text-yellow-300"></i>
                    <i class="fa-solid fa-star text-yellow-300"></i>
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesWomen/ShoesWomen4.jpg" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                    <small class="text-sm text-gray-600 block text-lime-900">Hoodie casual gris</small>
                    <h3 class="text-base font-semibold text-lime-900">Street Comfort</h3>
                    <i class="fa-solid fa-star text-yellow-300"></i>
                    <i class="fa-solid fa-star text-yellow-300"></i>
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesWomen/ShoesWomen5.webp" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                    <small class="text-sm text-gray-600 block text-lime-900">T-shirt graphique noir</small>
                    <h3 class="text-base font-semibold text-lime-900">Bold Statement</h3>
                    <i class="fa-solid fa-star text-yellow-300"></i>
                    <i class="fa-solid fa-star text-yellow-300"></i>
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesWomen/ShoesWomen6.jpg" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                    <small class="text-sm text-gray-600 block text-lime-900">Chemise bleue ciel</small>
                    <h3 class="text-base font-semibold text-lime-900">Smart Fit</h3>
                    <i class="fa-solid fa-star text-yellow-300"></i>
                    <i class="fa-solid fa-star text-yellow-300"></i>
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesWomen/ShoesWomen7.jpg" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                    <small class="text-sm text-gray-600 block text-lime-900">Sweat-shirt col rond</small>
                    <h3 class="text-base font-semibold text-lime-900">Weekend Vibes</h3>
                    <i class="fa-solid fa-star text-yellow-300"></i>
                    <i class="fa-solid fa-star text-yellow-300"></i>
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesWomen/ShoesWomen8.webp" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                    <small class="text-sm text-gray-600 block text-lime-900">T-shirt sport noir</small>
                    <h3 class="text-base font-semibold text-lime-900">Active Wear</h3>
                    <i class="fa-solid fa-star text-yellow-300"></i>
                    <i class="fa-solid fa-star text-yellow-300"></i>
                ...
                <li class="bg-lime-100 py-3 px-2 rounded-xl border-3 border-lime-800 shadow-lg hover:-translate-y-2">
                    <img src="colthingImage/ShoesImage/ShoesWomen/ShoesWomen9.webp" alt="" class="rounded-lg w-full  h-[30vh] sm:h-[15vh] xl:h-[25vh] object-cover">
                    <small class="text-sm text-gray-600 block text-lime-900">Polo rayé gris/blanc</small>
                    <h3 class="text-base font-semibold text-lime-900">Casual Lines</h3>
                    <i class="fa-solid fa-star text-yellow-300"></i>
                    <i class="fa-solid fa-star text-yellow-300"></i>
